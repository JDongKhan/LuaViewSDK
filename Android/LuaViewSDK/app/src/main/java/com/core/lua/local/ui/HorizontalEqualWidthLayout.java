 ...
 */
public class HorizontalEqualWidthLayout implements LuaLayout {
    @Override
    public void onMeasure(LuaViewGroup viewGroup, int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int l = 0, t = 0,w = (desireWidth-viewGroup.leftPadding-viewGroup.rightPadding)/cCount, h = desireHeight-viewGroup.topPadding-viewGroup.bottomPadding;
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            if (luaView.isHidden() == 0) {
                l = viewGroup.leftPadding+w*index;
                t = viewGroup.topPadding;
                index++;
            }
            cl = l;
            ct = t;
